...
namespace WebConsultasMedicas.Migrations
{
    ...
    [Migration("20260418193011_SeedAdminUser")]
            ...
            modelBuilder.Entity("WebConsultasMedicas.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdUsuario = 1,
                            ClaveHash = "240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9",
                            Correo = "admin@siscitasweb.local",
                            Estado = true,
                            FechaRegistro = new DateTime(2026, 4, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IdRol = 1
                        });
                });
